...
import pickle
from model.model import find_simi_place
import json
...
def base():
    map = folium.Map(
        location=[37.553685, 126.825084], # 서울 강서구 중앙값
    ...
    geojson_layer = folium.GeoJson('geocode/GangseoDong.geojson', name='강서구',
...
def search():
    ...
    if place_name:
        ...
        # 강서구 GeoJson 파일 읽기
        with open('geocode/GangseoDong.geojson', 'r', encoding='utf-8') as f:
